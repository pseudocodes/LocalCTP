...
buildFunc(){
    ...
    mv ${INSTALL_PATH}/libthosttraderapi_se.dylib ${INSTALL_PATH}/libthosttraderapi_se_v$1.dylib
}
...
cp ${INSTALL_PATH}/libthosttraderapi_se_v6.7.2.dylib ${INSTALL_PATH}/libthosttraderapi_se.dylib
