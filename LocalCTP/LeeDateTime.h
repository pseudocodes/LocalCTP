...
public:
    ...
    {
        return m_span - rhs.m_span < THREE_MILLISECOND && rhs.m_span - m_span < THREE_MILLISECOND;
    }
...
public:
    ...
    CLeeDateTime(double d)
        : m_dt(d)
    {
    }
    CLeeDateTime(time_t t)
        : m_dt(CLeeDateTime::time_t_to_double(t))
    {
    }
    ...
    CLeeDateTime(const CLeeDateTime& c)
        : m_dt(c.m_dt)
    {
    } // 拷贝构造函数
